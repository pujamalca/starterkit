            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div class="space-y-2">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex flex-col gap-2 text-sm text-gray-300 md:flex-row md:items-center md:gap-4">
                            ...
                            <span class="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gray-400">
                                <span class="h-1.5 w-16 rounded-full bg-gradient-to-r from-gray-500 via-gray-200 to-transparent"></span>
                                Snapshot Real-time
                            </span>
                        </div>
                    </div>
                ...
                <div class="flex flex-col items-start gap-4 md:flex-row md:items-end md:gap-6 lg:flex-col lg:items-end">
                    <span class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-semibold uppercase tracking-wide text-gray-900 {{ $overallPalette }}">
                        <span class="size-2 rounded-full bg-white/80"></span>
                        {{ strtoupper($overallStatus) }}
                    </span>
                    <div class="grid grid-cols-3 gap-3 text-xs font-medium text-gray-200">
                        @foreach ($statusLegend as $item)
                            <div class="rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-center">
                                ...
                                <div class="flex items-center justify-center gap-1 text-[10px] uppercase tracking-wider text-gray-300">
        ...
        <div class="space-y-4">
            ...
            <div class="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                @foreach ($checks as $key => $check)
                    ...
                    <div class="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <dl class="relative mt-5 space-y-3 text-sm">
                            @foreach ($check as $attribute => $value)
                                ...
                                <div class="flex items-start justify-between gap-x-3 border-b border-gray-100 pb-2 last:border-none last:pb-0 dark:border-gray-700">
        ...
        <div class="space-y-6">
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                @foreach ($analyticsGroups as $section => $metrics)
                    <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-900">
                        <div class="flex items-center justify-between">
                            <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-100">
                                {{ $section }}
                            </h4>
                            <span class="text-2xs uppercase tracking-widest text-gray-400 dark:text-gray-500">
                                Snapshot
                            </span>
                        </div>
                        <div class="mt-5 grid gap-4 sm:grid-cols-2">
                            @foreach ($metrics as $key => $label)
                                <div class="rounded-2xl border border-gray-100 bg-white px-4 py-3 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                    <dt class="text-2xs font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500">
                                        {{ $label }}
                                    </dt>
                                    <dd class="mt-2 text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <div class="space-y-4">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                @foreach ($versions as $package => $version)
                    <div class="rounded-3xl border border-gray-200 bg-white px-5 py-4 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-900">
                        <div class="flex items-center justify-between">
